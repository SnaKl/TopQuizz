...
public class AnswerRecapActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mQuestionsListContainer = findViewById(R.id.answer_recap_questionsListContainer_lt);
        ...
        mReturnMenu.setOnClickListener(v -> {
            Intent GameActivity = new Intent(AnswerRecapActivity.this, MainMenuActivity.class);
